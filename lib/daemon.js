...
class SwarmDaemon {
  ...
  async handleRequest(req, res) {
    ...
    res.end(JSON.stringify({ error: 'Not found', available: ['/health', '/status', '/capabilities', '/parallel', '/research', '/skeleton', '/chain', '/chain/auto', '/chain/template', '/chain/preview', '/templates', '/benchmark', '/cache'] }));
  }
